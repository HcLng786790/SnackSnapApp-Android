...
public class DeliveredFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_delivered, container, false);

        recyclerView = mView.findViewById(R.id.rcv_delevered);
    ...
    private void loadOrders() {
        ...
        ordersApi.getAllByStatus(Orders.DELIVERED, MainActivity.user.getId())
