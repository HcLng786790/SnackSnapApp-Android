...
public class DeliveringFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_delivering, container, false);

        recyclerView = mView.findViewById(R.id.rcv_delivering);
    ...
    private void loadOrders() {
        ...
        ordersApi.getAllByStatus(Orders.DELIVERING, MainActivity.user.getId())
